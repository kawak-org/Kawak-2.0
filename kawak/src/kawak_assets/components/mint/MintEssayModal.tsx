								...
								<div className='flex  md:items-center'>
									<div className='flex mt-3 flex-col space-y-2 sm:mt-0  '>
										...
										<div className='flex sm:text-left mt-2'>
											<p className='text-sm text-[#141414]'>Do you want to mint the essay you have crafted as an Nft .</p>
										</div>
										{/* <input
								...
								{loading ? (
									...
									<div className="flex gap-4">
										<button
											type='button'
											onClick={() => Modal(false)}
											className="py-2 px-8  bg-[#141414]/10 text-[#141414] w-full text-sm "
										>
											Cancel
										</button>
										<button
											type='button'
											onClick={handleMint}
											className="py-2 px-8 bg-[#08172E] text-white w-full text-sm "
										>
											Mint
										</button>
									</div>
