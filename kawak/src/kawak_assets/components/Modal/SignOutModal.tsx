          ...
          <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-center justify-center min-h-full p-4 text-center sm:p-0">
              <div className="relative dark:bg-[#323f4b] bg-white rounded-lg text-center overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
                <div className="dark:bg-[#323f4b] bg-white px-4 pt-5 shadow-md pb-4 sm:p-6 sm:pb-4">
                  <div className=" flex  flex-col w-full  sm:w-[28rem] p-4 h-[11rem]  ">
                    <h4 className="font-medium text-[#08172E] dark:text-white/90 text-base ">
                      Sign Out of Kawak
                    </h4>
                    <p className="text-[#141414]/60 dark:text-white/90 text-sm my-2">
                    ...
                    <div className=" flex mt-2 flex-row  ">
                      <button
                        onClick={() => modal(false)}
                        className="py-2 px-8 bg-[#141414]/10 text-[#141414] dark:text-white/70 w-full text-xs sm:text-sm "
                      >
                        Cancel
                      </button>
                      <button
