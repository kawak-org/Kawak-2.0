      ...
      <div>
			...
			>
                ...
                <div className=" flex  flex-col w-full  sm:w-[28rem] p-4 h-[11rem]  ">
                    <h4 className="font-medium text-[#08172E] text-base ">Sign Out of Kawak</h4>
                    <p className="text-[#141414]/60 text-sm my-2">A sign out has been requested for your account . Are you sure you want to sign out from it ?</p>
                    <div className=" flex mt-2 flex-row  ">
                      <button
                        onClick={()=> modal(false)}
                        className="py-2 px-8 bg-[#141414]/10 text-[#141414] w-full text-xs sm:text-sm " 
                      >
                        Cancel
                      </button>
                      <button
