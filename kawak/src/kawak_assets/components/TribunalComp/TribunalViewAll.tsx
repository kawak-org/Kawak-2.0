          ...
          {openTab &&
            <div className="bg-[#fff] absolute shadow-md top-[3rem] right-[-.5rem] flex z-20 flex-col rounded-[10px] p-4  w-[200px] ">
              ...
              <Link to="/tribunal-essay-view">
                  <button className='hover:bg-[#F98E2D]/20 p-2 w-full rounded-[4px] hover:text-[#F98E2D] bg-[#F98E2D] text-white ' > View </button>
              </Link>
            </div>
...
export default TribunalViewAll;