  ...
  return (
      <div className='group'>
         <div className='grid grid-cols-4 lg:grid-cols-8 p-4 lg:gap-x-16 gap-x-6 justify-between hover:cursor-pointer  hover:shadow-lg border-[1px] border-[#D9D9D9]/30 rounded-[8px] relative'>
           ...
           <p className=' hidden lg:flex justify-center items-center'>Web2 vs web3</p>
           ...
           <p className='hidden lg:flex justify-center  items-center'>22 December,2022</p>
        <div className='hidden lg:flex justify-center items-center  '> <p className='border-r-[1px] border-[#141414]/10 h-6' /> </div>
        <button className='hidden lg:flex justify-center items-center bg-[#152537]/20 p-2 rounded-[4px] text-[#152537] group-hover:bg-[#152537] group-hover:text-white ' onClick={()=> setShowProfile(!showProfile)} > View </button> 
          ...
          {openTab &&
            <div className="bg-[#fff] absolute shadow-md top-[3rem] right-[-.5rem] flex z-20 flex-col rounded-[10px] p-4  w-[200px] ">
                <h4 className="text-[#141414]/70 font-semibold text-sm"> More Option</h4>
                  ...
                  <button className='hover:bg-[#F98E2D]/20 p-2 rounded-[4px] hover:text-[#F98E2D] bg-[#F98E2D] text-white ' onClick={()=> {setShowProfile(!showProfile), setOpenTab(!openTab)}} > View </button>
            </div>
