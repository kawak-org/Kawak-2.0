		...
		<div>
				...
				<div className=' flex sm:hidden mx-4'>
					...
					{showNavbar && (
						...
						<div className=' flex flex-col justify-center mt-20 items-center w-full '>
							...
							<NavLink
								to='/admin-essays/admin-all-essays'
								className={({ isActive }) =>
									isActive
										? " text-white text-sm bg-[white]/10 px-6 py-2 mt-7 rounded-[4px]"
										: " text-white  mt-7 text-sm"
			...
			<div className=' hidden md:flex mr-5 justify-center items-center '>
				...
				{showProfile && (
					...
					<div className='grid grid-cols-2 mg:grid-cols-3 gap-5 mt-4'>
						<Link to="/my-essay/all-essays">
							<div
								className='bg-[#F98E2D]/30 h-[6rem] w-[6.2rem] md:h-[7rem] md:w-[7.2rem] rounded-[10px] cursor-pointer flex flex-col items-center
															p-6'
							>
								<h1 className='text-[#141414] font-bold text-lg md:text-2xl'>
									3
								</h1>
								<h1 className='text-[#141414] font-medium text-xs '>My Essays</h1>
							</div>
						</Link>
						<div
							className='bg-[#F98E2D]/30 h-[6rem] w-[6.2rem] md:h-[7rem] md:w-[7.2rem] rounded-[10px] flex flex-col items-center
														 p-6'
						>
							<h1 className='text-[#141414] font-bold text-lg md:text-2x'>
								4
							</h1>
						...
						<Link to="/my-NFTs">
							<div
								className='bg-[#F98E2D]/30 h-[6rem] w-[6.2rem] md:h-[7rem] md:w-[7.2rem] cursor-pointer rounded-[10px] flex flex-col items-center
															p-6'
							>
								<h1 className='text-[#141414] font-bold text-lg md:text-2x'>
									3
						...
						>
							<div className='flex '>
								...
								<h1 className='text-[#141414] font-bold text-lg md:text-2x ml-2'>
									7
								</h1>
							</div>
