					...
					{/* ) : ( */}
						...
						>
							{nfts?.map((minted: MintedEssayType) => (
								<div key={minted.id}>
									<div className='bg-white shadow-xl rounded-[10px] py-3 px-4 max-w-sm hover:scale-105 cursor-pointer transition-transform duration-200 ease-in-out'>
										<div
											className='flex flex-row justify-between items-center mt-5'
											onClick={() => setOpenModal(true)}
										>
											<h2 className=' text-[#08172E] font-bold text-base'>
												{minted.title}
											</h2>
										...
										<div className='flex flex-row justify-between items-center '>
											...
											>
												<span className='ml-3 underline underline-offset-2 flex flex-col justify-between '>
													List your Nft
												</span>
											</div>
