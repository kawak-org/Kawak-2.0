...
export default function Page() {
    ...
    useEffect(() => {
        tl.from(logoAnim.current, {
            y: "100",
            duration: 1.6,
            opacity: 0,
        }, 1);
        tl.from([menu1.current, menu2.current, menu3.current, menu4.current], {
            opacity: 0,
            y: 150,
            duration: 1.6,
            stagger: {
    ...
    return (
        <div className='p-0 m-0'>
            <section className='bg-[#F98E2D]/10 h-screen  flex flex-col relative '>
                <img
                    // ref={line_1}
                    ...
                    {iiAuth === false ?
                        <div className="block z-50 sm:hidden">
                            <IoIosMenu
                                ...
                                className={navBar ? " mr-4 text-white w-[2rem] h-[2.2rem] cursor-pointer" : "w-[2rem] h-[2.2rem] cursor-pointer"}
                            />
                            {showNavbar && (
                ...
                <div className='flex flex-col lg:flex-row justify-center lg:justify-start items-center mt-12 '>
                    ...
                    <div className='relative hidden lg:block '>
                        <img
                            ref={image1}
                            className='opacity-100' src={`forgee.png`} alt='' />
                        <img
                            ref={image2}
            ...
            <section className='bg-white z-50  flex flex-col mx-4 sm:mx-16' id='how-it-works'>
                <div ref={section} className='flex flex-col justify-center items-center mt-16 '>
                    ...
                    <div className="group card-content">
                        <div className='flex flex-row bg-white hover:shadow-lg px-4 py-8 border-2 border-[#08172E]/10 rounded-[10px] group-hover:bg-[#F98E2D] '>
                            <div className='w-[15%] md:w-[10%] bg-[#F98E2D] group-hover:bg-white rounded-[6px] h-[53px] justify-center flex items-center'>
                                <HiOutlineUserGroup
                                    className="text-white group-hover:text-[#F98E2D]"
                                />
                            </div>
                            <div className='flex flex-col w-[85%] md:w-[90%] ml-3'>
                                ...
                                <p className='text-[#152537] group-hover:text-white  text-xs md:text-sm mt-5'>
                                    You hear it a lot but here it’s actually true. Every mind that engages with the work of others has the opportunity to both find and be a mentor.
                                    <span className='text-[#F98E2D] group-hover:text-white '> Participation</span> is the metric used to measure<span className='text-[#F98E2D] group-hover:text-white '> the weight of your vote</span>.
                    ...
                    <div className="group card-content">
                        <div className='flex flex-row bg-white hover:shadow-lg  px-4 py-8 border-2 border-[#08172E]/10 rounded-[10px]  group-hover:bg-[#F98E2D]'>
                            ...
                            <div className='flex flex-col w-[85%] md:w-[90%] ml-3'>
                                ...
                                <p className='text-[#152537] group-hover:text-white text-xs md:text-sm mt-5'>
                                    Do not rate others generously based on how much they said <span className='text-[#F98E2D] group-hover:text-white '> what you wanted to hear</span>.
                                    But rather the degree with which they genuinely engaged with your work.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="group card-content">
                        <div className='flex flex-row bg-white px-4 py-8 hover:shadow-lg border-2 border-[#08172E]/10 rounded-[10px] group-hover:bg-[#F98E2D]'>
                            ...
                            <div className='flex flex-col w-[85%] md:w-[90%] ml-3'>
                                ...
                                <p className='text-[#152537] group-hover:text-white  text-xs md:text-sm mt-5'>
                                    We define good writing as <span className='text-[#F98E2D] group-hover:text-white '>clear</span> and <span className='text-[#F98E2D] group-hover:text-white '>concise</span>.
                                    Where sharp communcation and authentic crticism are vital naviagtional tools for the 21st century.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="group card-content">
                        <div className='flex flex-row bg-white px-4 py-8 hover:shadow-lg border-2 border-[#08172E]/10 rounded-[10px]  group-hover:bg-[#F98E2D]'>
                            ...
                            <div className='flex flex-col w-[85%] md:w-[90%] ml-3'>
                                ...
                                <p className='text-[#152537] group-hover:text-white  text-xs md:text-sm mt-5'>
                                    Reducing the barrier of <span className='text-[#F98E2D] group-hover:text-white '>access to education is critical</span> in a time of global uncertainty.
                                    Miracles can only come from the minds of those blessed with <span className='text-[#F98E2D] group-hover:text-white '>constructive feedback</span>.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className=' mx-8 sm:mx-16 mt-[8.3rem]'>
                <div className='grid grid-cols-1 md:grid-cols-2 items-center gap-[4rem]'>
                    <div className='flex flex-col mt-8 tag'>
                        ...
                        <div className=' mt-3 flex flex-col'>
                            ...
                            <div className='flex flex-row  my-3 '>
                                <div className='bg-[#066042] w-4 h-4 p-3 rounded-full'></div>
                                <p className='text-[#152537] ml-2 text-sm flex
                                 '>
                ...
                <div className='flex flex-col-reverse md:flex-row items-center gap-[4rem] mt-[10rem]'>
                    <div className='relative mt-[3.9rem] anvil'>
                        <img className='z-20 anvil-content' src={`text-editor.png`} alt='' />
                        <img
                            className='absolute z-[-20] bottom-0 left-[-13rem]'
                            src={`pink.png`}
                            alt=''
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 items-center gap-[4rem] mt-[10rem]'>
                    ...
                    <div className='relative mt-[3.9rem] tribunal2'>
                        <img className='z-20 tribunal-content2' src={`forge-3.png`} alt='' />
                        <img
            ...
            <section className='mx-4 sm:mx-16 mt-[5rem] freq' id='Faq'>
                ...
                <p className='my-4  max-w-[500px]'>
                    If you can’t find what you’re looking for, feel free to email our support team at
                    <span
                        onClick={() => win.location = "mailto:marvellous@kawak.org?subject=SendMail&body=Description"}
                        className='text-[#F98E2D] cursor-pointer'> contact@kawak.org</span>
                </p>
