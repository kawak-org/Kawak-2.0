      ...
      <div className="flex flex-col items-center justify-center px-2 py-3 mt-20 ">
        {step === 1 ? (
          <>
            {/* Title */}
            <div
              className="flex flex-col border-inherit border-2 bg-white  w-[80%]
			 "
            >
              <input
                value={title}
                onChange={(e: any) => setTitle(e.target.value)}
                className="text-md py-4 px-5 outline-none border border-gray-200  text-red.500 rounded-md placeholder:text-xl placeholder:font-bold placeholder:text-[#141414A6] w-[80%]"
