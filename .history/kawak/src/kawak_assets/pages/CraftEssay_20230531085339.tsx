          ...
          <>
            ...
            >
              <input
                ...
                className="text-md py-4 px-5 outline-none border dark:bg-[#323f4b] dark:border-[#3e5060] border-gray-200  dark:text-white text-red.500 rounded-md placeholder:text-xl placeholder:font-bold dark:placeholder:text-white placeholder:text-[#141414A6] w-[100%]"
