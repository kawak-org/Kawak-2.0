    ...
    <div>
      ...
      <div className="relative px-6 mb-8 mt-[6rem]">
        ...
        >
          ...
          <p className="text-[#08172E] text-lg font-semibold ml-4 dark:text-white">
            Back
          </p>
        </div>
        ...
        <div className="md:mx-16 xs:ml-5 mt-5">
          ...
          <div className="mt-6">
            ...
            <h2 className="justify-center dark:text-white text-[#08172E] m-auto text-2xl font-semibold mt-4">
            ...
            <ul className="ml-8 list-disc dark:text-white/70">
              <li>
                <p className="text-[#141414] dark:text-white/70 my-2 text-sm">
                  Email address
                </p>
            ...
            <h2 className="justify-center text-[#08172E] dark:text-white/70 m-auto text-xl font-semibold my-3">
