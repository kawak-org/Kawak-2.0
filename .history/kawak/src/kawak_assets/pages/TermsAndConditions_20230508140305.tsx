		...
		<div>
			...
			<div className='relative px-6 mb-8 mt-[6rem]'>
				...
				<div className='md:mx-16 xs:ml-5 mt-5'>
					<h2 className='justify-center text-[#08172E] m-auto text-3xl font-bold mt-4'>
						Terms Of Use
					</h2>
					...
					<div className='mt-6'>
						<p className='text-[#141414] mt-1 text-sm'>
						...
						<h2 className='justify-center text-[#08172E] m-auto text-2xl font-semibold mt-4'>
							Interpretation and Definitions
						</h2>
						<h2 className='justify-center text-[#08172E] m-auto text-xl font-semibold my-3'>
							Interpretation
						</h2>
						<p className='text-[#141414] mt-1 text-sm'>
						...
						<ul className='ml-8 list-disc'>
							<li className='text-[#141414] my-2 text-sm'>
						...
						<h2 className='justify-center text-[#08172E] m-auto text-2xl font-semibold my-3'>
						...
						<ul className='ml-8 list-disc'>
							<li>
								<p className='text-[#141414] my-2 text-sm'>Email address</p>
							</li>
							<li>
								<p className='text-[#141414] my-2 text-sm'>Usage Data</p>
							</li>
						</ul>
						<h2 className='justify-center text-[#08172E] m-auto text-xl font-semibold my-3'>
							Usage Data
