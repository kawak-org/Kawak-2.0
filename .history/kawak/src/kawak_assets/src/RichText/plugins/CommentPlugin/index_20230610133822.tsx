          ...
          return (
            ...
            >
              <div className="CommentPlugin_CommentsPanel_List_Thread_QuoteBox">
                <blockquote className="CommentPlugin_CommentsPanel_List_Thread_Quote p-2 ">
                  <span className="dark:bg-[#5e6d7b] dark:text-white/90">
              ...
              <ul className="CommentPlugin_CommentsPanel_List_Thread_Comments dark:text-white/90">
