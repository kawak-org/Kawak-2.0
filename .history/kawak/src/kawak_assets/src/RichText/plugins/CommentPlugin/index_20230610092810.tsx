...
function CommentInputBox({
  ...
  return (
    <div
      className="CommentPlugin_CommentInputBox dark:bg-[#323f4b] "
      ref={boxRef}
    >
      <PlainTextEditor
        className="CommentPlugin_CommentInputBox_Editor dark:bg-[#425363] dark:border dark:border-solid dark:border-white/30 dark:text-white/90"
        onEscape={onEscape}
        onChange={onChange}
      />
      <div className="CommentPlugin_CommentInputBox_Buttons">
        <Button
          ...
          className="CommentPlugin_CommentInputBox_Button dark:text-white/90 dark:bg-white/20"
        >
          Cancel
        </Button>
        <Button
          ...
          disabled={!canSubmit}
          className="CommentPlugin_CommentInputBox_Button primary dark:bg-[#425363] dark:text-white/90"
        >
          Comment
        </Button>
      </div>
