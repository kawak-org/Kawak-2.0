        ...
        if (commentOrThread.type === "thread") {
          ...
          return (
            ...
            <li
              ...
              className={`CommentPlugin_CommentsPanel_List_Thread dark:bg-[#495561] dark:active:bg-[#495561] dark:hover:bg-[#495561]   ${
                markNodeMap.has(id)
                  ? "interactive dark:bg-[#495561] dark:active:bg-[#495561]"
                  : "dark:bg-[#495561] dark:active:bg-[#495561]"
              } ${
                activeIDs.indexOf(id) === -1
                  ? " dark:bg-[#495561] dark:active:bg-[#495561]"
                  : "active dark:bg-[#495561] dark:active:bg-[#495561]"
              }`}
            >
