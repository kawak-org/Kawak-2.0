...
function CommentInputBox({
  ...
  return (
    ...
    >
      <PlainTextEditor
        className="CommentPlugin_CommentInputBox_Editor dark:placeholder:text-white/90 dark:bg-[#425363] dark:border dark:border-solid dark:border-white/30 dark:text-white/90"
        onEscape={onEscape}
        onChange={onChange}
      />
      <div className="CommentPlugin_CommentInputBox_Buttons">
        ...
        <Button
          ...
          disabled={!canSubmit}
          className="CommentPlugin_CommentInputBox_Button  dark:bg-[#425363] dark:text-white/90 dark:hover:dark:bg-[#425363]"
        >
          Comment
        </Button>
      </div>
