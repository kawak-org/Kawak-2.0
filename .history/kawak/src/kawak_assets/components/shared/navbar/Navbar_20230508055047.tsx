...
const Navbar = () => {
  ...
  return (
    <div className="fixed dark:bg-[] top-0 z-30 bg-white sm:bg-[#08172E] h-[4rem] flex flex-rol items-center justify-between w-full">
      <div>
        <img
        ...
        {showNavbar && (
          <div className="fixed h-screen flex flex-col w-[80%] p-4 right-0 top-0 bg-[#08172E]">
            ...
            >
              ...
              {openProfile && (
                <div className="dark:bg-[#616E7C] bg-white absolute top-[3.7rem] right-[.5rem] shadow-md  flex z-20 flex-col rounded-[5px] p-4  w-[200px] h-[290px] ">
      ...
      >
        ...
        {openProfile && (
          <div className="dark:bg-[#252526] bg-white absolute top-[3.4rem] right-[-1.5rem] shadow-md  flex z-20 flex-col rounded-[5px] p-4  w-[220px] h-[290px] ">
            <div className=" flex flex-col  justify-between  ">
              <p className="text-gray-400 my-2 text-xs font-normal">
                Signed in as
              </p>
