...
const Navbar = () => {
  ...
  return (
    <div className="fixed dark:bg-[#323f4b] top-0 z-30 bg-white sm:bg-[#08172E] h-[4rem] flex flex-rol items-center justify-between w-full">
      ...
      >
        <IoIosArrowRoundBack className=" text-black sm:text-white w-7 h-7" />
        <h3 className="text-black sm:text-white">Back</h3>
      </div>
              ...
              {openProfile && (
                <div className="bg-white absolute top-[3.7rem] right-[.5rem] shadow-md  flex z-20 flex-col rounded-[5px] p-4  w-[200px] h-[290px] ">
                  ...
                  <div className="flex flex-col">
                    <p
                      className="text-gray-500 text-xs my-2  dark:hover:text-white/60 relative hover:bg-gray-200 p-1 hover:w-full font-normal cursor-pointer"
                    ...
                    <Link to="/terms-and-conditions">
                      <p className="text-gray-500 text-xs my-2 dark:hover:text-white/60 hover:bg-gray-200 p-1 hover:w-full font-normal cursor-pointer">
                        Terms of Use
                      </p>
                    </Link>
                  ...
                  <div className="flex flex-row  ">
                    <p
                      ...
                      className="text-[#EF4444] font-medium dark:hover:text-white/60 hover:bg-gray-200 p-1 hover:w-full text-sm cursor-pointer"
                    >
                      Sign Out
                    </p>
                  </div>
      ...
      >
        ...
        {openProfile && (
          <div className="dark:bg-[#323f4b] bg-white absolute top-[3.4rem] right-[-1.5rem] shadow-md  flex z-20 flex-col rounded-[5px] p-4  w-[220px] h-[290px] ">
            ...
            <div className="flex flex-col">
              <p
                className="text-gray-500 text-xs my-2  relative dark:hover:text-white/60 hover:bg-gray-200 p-1 hover:w-full font-normal cursor-pointer"
                onClick={() => setShowProfile(!showProfile)}
              >
                My Profile
              </p>
