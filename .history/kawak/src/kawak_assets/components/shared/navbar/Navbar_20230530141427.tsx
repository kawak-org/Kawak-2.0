      ...
      {showProfile && (
        <div className="absolute dark:bg-[#364451] bg-white z-10 right-[1rem] top-[5rem] shadow-lg p-2 sm:p-6 flex flex-col w-[70%] sm:w-[28rem] h-fit sm:h-[30rem] rounded-xl justify-center items-center ">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            />
            <h4 className="text-[#141414] dark:bg-white/60  font-semibold mt-2 text-base sm:text-lg">
              {user.username}
            </h4>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-5 mt-4">
            <Link to="/my-essay/all-essays">
              <div
                className="bg-[#F98E2D]/30 dark:bg-[#F98E2D]/50 h-[6rem] w-[6.2rem] sm:h-[7rem] sm:w-[7.2rem] rounded-[10px] cursor-pointer flex flex-col items-center
															p-6"
              >
                <h1 className="text-[#141414] dark:bg-white/60  font-bold text-lg sm:text-2xl">
                  {user.noOfEssays}
                </h1>
            ...
            <div
              className="bg-[#F98E2D]/30 dark:bg-[#F98E2D]/50 h-[6rem] w-[6.2rem] sm:h-[7rem] sm:w-[7.2rem] rounded-[10px] flex flex-col items-center
														 p-6"
            >
            ...
            <Link to="/my-NFTs">
              <div
                className="bg-[#F98E2D]/30 dark:bg-[#F98E2D]/50 h-[6rem] w-[6.2rem] sm:h-[7rem] sm:w-[7.2rem] cursor-pointer rounded-[10px] flex flex-col items-center
															p-6"
              >
                <h1 className="text-[#141414] font-bold text-lg sm:text-2x">
                  {nfts?.length}
