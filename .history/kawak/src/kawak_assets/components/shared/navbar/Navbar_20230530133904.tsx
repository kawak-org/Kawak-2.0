  ...
  return (
    <div className="fixed dark:bg-[#323f4b] top-0 z-30 bg-white sm:bg-[#08172E] h-[4rem] flex flex-rol items-center justify-between w-full">
      ...
      <div className=" flex sm:hidden mx-4">
        ...
        />
        {showNavbar && (
          <div className="fixed h-screen flex flex-col w-[80%] p-4 right-0 top-0 dark:bg-[#323f4b] bg-[#08172E]">
            ...
            >
              ...
              {openProfile && (
                <div className="dark:bg-[#323f4b] bg-white absolute top-[3.7rem] right-[.5rem] shadow-md  flex z-20 flex-col rounded-[5px] p-4  w-[200px] h-[290px] ">
