    ...
    <div className="flex justify-center items-center">
      <div className="flex flex-row justify-center items-center mr-4">
        <div className="relative">
          <button
            className="flex relative justify-center items-center bg-transparent px-2 ml-7 py-2 border border-solid dark:border-white dark:text-white border-[#08172E] text-sm  rounded-[4px]"
          ...
          {openSort && (
            <div className=" bg-white absolute shadow-md left-[-6.3rem] flex z-20 flex-col rounded-[10px] py-4 pl-4 pr-8 w-[220px] ">
        ...
        <div className="relative">
          <button
            className="flex justify-center items-center bg-transparent px-2 ml-7 py-2 border border-solid border-[#08172E] text-sm  rounded-[4px]"
            onClick={() => setOpenFilter(!openFilter)}
          >
            <BiFilterAlt className="text-lg mr-2 text-black" />
            Filter
          </button>
          {openFilter && (
            <div className="bg-white absolute shadow-md left-[2rem] flex z-20 flex-col rounded-[10px] p-4  w-[285px] ">
              <div className=" flex flex-row mt-4 justify-between cursor-pointer ">
                <p className="ml-3 text-xs font-medium">Reviewed Essay</p>
                <input
                  value=""
                  type="checkbox"
              ...
              <div className="flex flex-row mt-4 justify-between cursor-pointer">
                <p className="ml-3 text-xs font-medium">Not Reviewed Essay</p>
                <input
                  value=""
                  type="checkbox"
                  className="bg-gray-100  focus:ring-0 border-gray-300 "
              ...
              <div className="flex flex-row justify-between items-center mt-6 ">
                ...
                <button className="bg-[#08172E] text-white text-xs py-3 px-10">
                  Apply Filter
                </button>
              </div>
            </div>
