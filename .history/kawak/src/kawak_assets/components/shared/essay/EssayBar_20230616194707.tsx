...
function EssayBar() {
  ...
  console.log(tag);
  return (
    <div className="flex relative justify-center md:mt-6 items-center">
      <div className="flex absolute bottom-0 right-0 left-0 top-[20%] m-[auto]  md:relative flex-row justify-center items-center mr-4">
        <TagPicker
          data={data}
