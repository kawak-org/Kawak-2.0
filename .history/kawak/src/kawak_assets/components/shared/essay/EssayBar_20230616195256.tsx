...
function EssayBar() {
  ...
  console.log(tag);
  return (
    <div className="flex justify-between md:justify-center md:mt-6 items-center">
      <div className="flex absolute right-0 top-[20%] left-0 my-0 mx-[auto] md:relative flex-row justify-center items-center mr-4">
        <TagPicker
          data={data}
