  ...
  return (
    <div className="flex justify-between mt-6  md:mt-6 items-center">
      ...
      <div className="flex ml-3 md:ml-5">
        ...
        <button
          onClick={() => navigate("/craft")}
          className=" sm:hidden craft-Essay text-white dark:bg-[#627D98] hover:no-underline dark:hover:text-white dark:hover:bg-[#9AA5B1] bg-[#08172E] hover:bg-primary-light hover:text-black"
        >
          Create
        </button>
      </div>
