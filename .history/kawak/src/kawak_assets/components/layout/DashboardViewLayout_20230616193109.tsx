...
const DashboardViewLayout = ({ heading }: Props) => {
  ...
  return (
    <div className="dark:bg-[#1f2933] mx-4 sm:mx-8 mb-6 mt-28">
      <div className="flex md:flex-row w-full md:justify-between md:items-center relative mt-10">
        <h4 className="dark:text-white font-bold text-2xl mt-[-1rem] sm:mt-0 md:text-4xl ">
          {heading}
        </h4>
