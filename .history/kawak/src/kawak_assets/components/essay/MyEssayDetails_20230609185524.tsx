            ...
            <div className="mx-4 sm:ml-16 ">
              <div className="flex flex-row gap-6 relative">
                ...
                <button
                  ...
                  className="py-2 fixed dark:bg-[#627D98] dark:hover:bg-[#9AA5B1] dark:hover:text-white  top-[4.7rem] sm:top-[4.5rem] lg:hidden right-[1rem] px-8 text-white dark:bg-[#F98E2D]/80 bg-[#F98E2D] cursor-pointer"
                >
                  Comment
                </button>
