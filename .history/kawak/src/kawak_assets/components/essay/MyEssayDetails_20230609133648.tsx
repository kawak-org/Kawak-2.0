          ...
          <div className="flex flex-col">
            <div className="mx-4 sm:ml-16 ">
              <div className="flex flex-row gap-6 relative">
                ...
                {showComment && (
                  <div className=" dark: bg-white z-40 fixed w-[70%] sm:w-[40%] top-[0] left-0 mt-[1rem] ">
                    {review[0] == (null || undefined) ? (
                      <div className=" dark: bg-[#F98E2D]/10 rounded-[10px]  flex flex-col h-[37rem] py-8 px-4 mt-[.4rem] ">
                        <div className="flex  flex-col">
