...
const TagInput = () => {
  ...
  return (
    <div className=" flex flex-col gap-[.5em] flex-wrap  p-[.5em] rounded-[3px] w-full ">
      ...
      <div className="grid grid-cols-2 place-items-center md:flex gap-[1rem] mx-2">
        <button className="border  text-sm md:text-base cursor-pointer w-[fit-content] rounded-[9999px] border-gray-300 flex justify-center items-center px-4 py-3 ">
          Science
        </button>
        <button className="border text-sm md:text-base cursor-pointer w-[fit-content] rounded-[9999px] border-gray-300 flex justify-center items-center px-4 py-3 ">
          Blockchain
      ...
      {showInputTag && (
        <input
          ...
          type="text"
          className=" border border-gray-200 border-solid  my-2 grow py-[.5em] px-3 border-none outline-none "
