...
const TagInput = () => {
  ...
  return (
    <div className=" flex flex-col gap-[.5em] flex-wrap  p-[.5em] rounded-[3px] w-full ">
      ...
      <div className="flex flex-rol gap-[1rem] mx-2">
        <button className="border cursor-pointer rounded-[50%] border-gray-300 flex justify-center items-center px-5 py-3 ">
          Science
        </button>
        <button className="border cursor-pointer rounded-[50%] border-gray-300 flex justify-center items-center px-5 py-3 ">
          Blockchain
        </button>
        <button className="border cursor-pointer rounded-[9999px] border-gray-300 flex justify-center items-center px-5 py-3 ">
          Technology
        </button>
        <button
          onClick={() => setShowInputTag(true)}
          className="border cursor-pointer rounded-[20px] border-gray-300 flex justify-center items-center px-4 py-2 "
        >
          More
        </button>
      </div>
