    ...
    <div className=" flex flex-col gap-[.5em] flex-wrap  p-[.5em] rounded-[3px] w-full ">
      ...
      <div className="flex flex-wrap gap-[1rem] mx-2">
        {items.map((item, index) => (
          <button
            ...
            className="border dark:text-white/90 text-sm md:text-base cursor-pointer w-[fit-content] rounded-[9999px] border-gray-300 flex justify-center items-center px-4 py-2 "
          >
            {item.text}
          </button>
        ))}
        <button
          ...
          className="border dark:text-white/90 text-sm md:text-base cursor-pointer rounded-[9999px] w-[fit-content] border-gray-300 flex justify-center items-center px-4 py-2 "
        >
          More
        </button>
      </div>
      {showInputTag && (
        <input
          ...
          type="text"
          className=" border dark:bg-[#323f4b] dark:border-[#3e5060] dark:text-white border-gray-200 border-solid  my-2 grow py-[.5em] px-3 outline-none "
