...
const TagInput = () => {
  ...
  return (
    <div className=" flex flex-col gap-[.5em] flex-wrap  p-[.5em] rounded-[3px] w-full ">
      ...
      <div className="grid  grid-cols-4 grid-cols-3 place-items-center md:flex gap-[1rem] mx-2">
      ...
      {showInputTag && (
        <input
          ...
          type="text"
          className=" border border-gray-200  my-2 grow py-[.5em] px-3 border-none outline-none "
