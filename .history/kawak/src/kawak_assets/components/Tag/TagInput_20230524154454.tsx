...
const TagInput = () => {
  ...
  return (
    <div className=" flex flex-col gap-[.5em] flex-wrap  p-[.5em] rounded-[3px] w-full ">
      ...
      <div className="grid grid-cols-[repeat( auto-fit, minmax(250px, 1fr))] gap-[1rem] mx-2">
        <button className="border cursor-pointer rounded-[9999px] border-gray-300 flex justify-center items-center px-4 py-3 ">
          Science
        </button>
        <button className="border cursor-pointer rounded-[9999px] border-gray-300 flex justify-center items-center px-4 py-3 ">
          Blockchain
        ...
        <button
          ...
          className="border cursor-pointer rounded-[9999px] border-gray-300 flex justify-center items-center px-4 py-2 "
        >
          More
        </button>
      </div>
